      ...
      UserControl
  {
    ...
    private void updateTextFields()
    {
      ...
      try
      {
        ...
        if (_currentLeadingInputElement != LeadingInputElement.ClarionLongInput)
        {
          if (_changingControl != clarionLongTextBox)
          {
            clarionLongTextBox.Text = toClarionLong(color);
          }
        }
    ...
    private string toClarionLong(Color color)
    {
      return ColorTranslator.ToOle(color).ToString();
    }
      ...
      get
      {
        ...
        else
        {
          switch (_currentLeadingInputElement)
          {
            ...
            case LeadingInputElement.ClarionLongInput:
              {
                return ColorTranslator.FromOle(Int32.Parse(clarionLongTextBox.Text));
              }
      ...
      set
      {
        if (!DesignMode)
        {
          ...
          try
          {
            ...
            clarionLongTextBox.Text = toClarionLong(value);
